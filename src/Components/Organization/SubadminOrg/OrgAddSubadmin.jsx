...
function OrgAddSubadmin() {
  ...
  const [selectedProperties, setSelectedProperties] = useState([]); // Array of objects: [{ propertyId: string, agreementDuration: { years: number }, agreementEndDate: string (ISO) }]
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-indigo-100 via-white to-indigo-50 shadow-xl rounded-2xl border border-gray-200">
      <h2 className="text-3xl font-bold mb-6 text-center text-gray-800 tracking-wide">
        <FaUser className="inline mr-2" /> Add New Sub-Admin
      </h2>
...
export default OrgAddSubadmin;
//C:\Users\HP\Downloads\draze2.0\draze\src\Components\Organization\SubadminOrg\OrgAddSubadmin.jsx
//C:\Users\HP\Downloads\draze2.0\draze\src\Components\Organization\SubadminOrg\OrgSubadminDashboard.jsx, 
//C:\Users\HP\Downloads\draze2.0\draze\src\Components\Organization\SubadminOrg\OrgSubadminlist.jsx,
//C:\Users\HP\Downloads\draze2.0\draze\src\Components\Organization\SubadminOrg\OrgSubadminPermisson.jsx
