...
const TenantSidebar = ({ setSidebarWidth, tenantId }) => {
  ...
  const navItems = [
    { name: "Dashboard", path: "/pm_tenant", icon: Home, gradient: "from-blue-400 to-indigo-500" },
    { name: "Properties", path: "/pm_tenant/properties", icon: Building2, gradient: "from-purple-400 to-pink-500" },
    { name: "Rent Payments", path: tenantId ? `/pm_tenant/rent-payments/${tenantId}` : "/pm_tenant/rent-payments", icon: CreditCard, gradient: "from-green-400 to-teal-500" },
    { name: "Complaints", path: tenantId ? `/pm_tenant/complaints/${tenantId}` : "/pm_tenant/complaints", icon: FileText, gradient: "from-yellow-400 to-amber-500" },
    { name: "Announcements", path: tenantId ? `/pm_tenant/announcements/${tenantId}` : "/pm_tenant/announcements", icon: Megaphone, gradient: "from-emerald-400 to-green-500" },
    { name: "Documents", path: "/pm_tenant/documents", icon: Receipt, gradient: "from-indigo-400 to-purple-500" },
    { name: "Roomswitch", path: "/pm_tenant/room-switch", icon: Move, gradient: "from-pink-400 to-rose-500" },
    { name: "Police Verification", path: "/pm_tenant/police-verification", icon: FileText, gradient: "from-orange-400 to-rose-500" },
    { name: "Profile", path: "/pm_tenant/profile", icon: User, gradient: "from-cyan-400 to-blue-500" },
  ];
