// Sidebar.jsx (adapted for Property Owner)
    ...
    <>
      ...
      >
        ...
        {(isHovered || isMobileOpen) && (
          ...
          >
            {orgData ? orgData.organizationName : "Property Owner"}
          </motion.h2>
        )}
      </motion.div>
      ...
      <ul className="space-y-2 mt-6 px-2">
        ...
        {/* <li>
          ...
          >
            ...
            />
            {(isHovered || isMobileOpen) && <span>About</span>}
          </NavLink>
        </li> */}

        <li>
          <NavLink
            to="/property-owner/profile"
            className={({ isActive }) =>
              isActive ? `${linkClass} ${activeClass}` : linkClass
            }
            onClick={handleNavLinkClick}
