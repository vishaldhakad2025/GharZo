    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.message === "Login successful") {
          ...
          // Store token and regionalManager data in localStorage
          localStorage.setItem("token", token);
          localStorage.setItem("regionalManager", JSON.stringify(data));
          ...
          navigate("/regional_manager/dashboard");
        } else {
    ...
    <div className="fixed inset-0 flex items-center justify-center p-4 z-[9999]">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-center text-[#5C4EFF] mb-6">
          Login as <span className="text-green-700">Regional Manager</span>
        </h2>
...
export default RegionalManagerLogin;
