...
const facilityKeyMapping = {
  ...
  washroomHygiene: {
    "Attached Washroom": "attachedWashroom",
...
const RegionalManagerAddRooms = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setProperty(updatedRes.data.property);
      resetForm();
    } catch (err) {
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 flex items-center gap-1">
                <FaMapMarkerAlt />
                {property.address}, {property.landmark}, {property.pinCode}, {property.city}, {property.state}
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm text-gray-600">
            <span className="flex items-center gap-1">
              <FaPhone /> {property.contactNumber}
            </span>
            <span className="flex items-center gap-1">
              <FaUser /> {property.ownerName}
            </span>
...
export default RegionalManagerAddRooms;